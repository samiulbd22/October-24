...
const members = {
    ...
    "01814843266":{
        ...
        payment             :{"09/10/24-Cash":4500},
        // running month {"01/07/24-Cash":500}
        stay_cost       :2200,
        garage_cost     :0,
        running_payable :2656,
        running_paid    :4500,
        running_meal    :25,
        // method calling
        preMonth,
    ...
    "01922362569":{
        ...
        payment             :{"10/10/24-DBBL":2000,"16/10/24-Cash":1000,"27/10/24-Cash":500,"31/10/24-Cash":500},
        // running month
        stay_cost       :2000,
        garage_cost     :0,
        running_payable :2606,
        running_paid    :4000,
        running_meal    :25,
        // method calling
        preMonth,
    ...
    "01744459622":{
        ...
        previous_paid       :6000,
        previous_dining_cost:1596,
        payment             :{"07/10/24-Cash":3000,"13/10/24-Cash":1500,"29/10/24-Cash":1000},
        // running month
        stay_cost       :2700,
        garage_cost     :200,
        running_payable :3150,
        running_paid    :5500,
        running_meal    :47,
        // method calling
        preMonth,
    ...
    "01780608997":{
        ...
        payment             :{"19/10/24-Cash":5000},
        // running month
        stay_cost       :3500,
        garage_cost     :0,
        running_payable :4534,
        running_paid    :5000,
        running_meal    :25,
        // method calling
        preMonth,
    ...
    "01644377150":{
        ...
        payment             :{"06/10/24-Cash":2500,"15/10/24-Cash":3000},
        // running month
        stay_cost       :2400,
        garage_cost     :0,
        running_payable :3800,
        running_paid    :5500,
        running_meal    :58,
        // method calling
        preMonth,
    ...
    "01645122114":{
        ...
        previous_paid       :5000,
        previous_dining_cost:1425,
        payment             :{"14/10/24-Bkash":4000,"23/10/24-Bkash":1000},
        // running month
        stay_cost       :3000,
        garage_cost     :0,
        running_payable :4435,
        running_paid    :5000,
        running_meal    :34,
        // method calling
        preMonth,
    ...
    "01714443406":{
        ...
        payment             :{"02/10/24-Bkash":2000,"13/10/24-Bkash":3000,"23/10/24-Cash":1000},
        // running month
        stay_cost       :3000,
        garage_cost     :0,
        running_payable :5531,
        running_paid    :6000,
        running_meal    :29,
        // method calling
        preMonth,
    ...
    "01834648400":{
        ...
        payment             :{"19/10/24-Bkash":2000},
        // running month
        stay_cost       :2500,
        garage_cost     :0,
        running_payable :2166,
        running_paid    :2000,
        running_meal    :25,
        // method calling
        preMonth,
    ...
    "01749244430":{
        ...
        previous_paid       :7000,
        previous_dining_cost:1425,
        payment             :{"10/10/24-Cash":6000},
        // running month
        stay_cost       :3500,
        garage_cost     :0,
        running_payable :4585,
        running_paid    :6000,
        running_meal    :35,
        // method calling
        preMonth,
